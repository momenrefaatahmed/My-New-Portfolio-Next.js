...
const cardGLB = '/assets/card.glb' // تأكد المسار صحيح (داخل public/assets)
...
export default function Lanyard({
  ...
  return (
    <div className="relative z-0 w-full h-screen flex justify-center items-center">
      <Canvas
        camera={{ position: position, fov: isMobile ? 16 : fov }}
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile }) {
  ...
  return (
    <>
      <group position={[0, isMobile ? 3 : 4, 0]} scale={isMobile ? 0.8 : 1}>
        ...
        >
          ...
          <group
            ...
            onPointerMove={(e) => {
              // لو بتحرك في الموبايل أو الماوس
